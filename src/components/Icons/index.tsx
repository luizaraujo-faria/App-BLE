import { AntDesign, MaterialCommunityIcons, Ionicons, FontAwesome, Entypo, MaterialIcons } from '@expo/vector-icons';
...
export const MaterialIcon = ({ iconName, iconSize, iconColor }: IconProps) => {
    return(
